...
//                        QuizProperties.QuizType.RANDOM.toString().toLowerCase()));
//        RadioButton ratingBtn = new RadioButton(
//                CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL,
//                        QuizProperties.QuizType.RATING.toString().toLowerCase()));
//        RadioButton sessionBtn = new RadioButton(
//                CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL,
//                        QuizProperties.QuizType.SESSION.toString().toLowerCase()));
//        RadioButton errorsBtn = new RadioButton(
//                CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL,
//                        QuizProperties.QuizType.ERRORS.toString().toLowerCase()));
...
//                return new QuizProperties(QuizProperties.QuizType.RANDOM, testSize,
//                        (boolean) languageGroup.getSelectedToggle().getUserData());
//            }
//            if (resultType.equals(ratingBtn.getText())) {
//                return new QuizProperties(QuizProperties.QuizType.RATING, testSize,
//                        (boolean) languageGroup.getSelectedToggle().getUserData());
//            }
//            if (resultType.equals(errorsBtn.getText())) {
//                return new QuizProperties(QuizProperties.QuizType.ERRORS, testSize,
//                        (boolean) languageGroup.getSelectedToggle().getUserData());
//            }
//
//            return new QuizProperties(QuizProperties.QuizType.SESSION, testSize,
//                    (boolean) languageGroup.getSelectedToggle().getUserData(),
